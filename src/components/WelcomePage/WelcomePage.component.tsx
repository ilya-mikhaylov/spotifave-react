...
export const WelcomePageComponent: React.FunctionComponent = () => (
  <div className="welcome-container info">
    <div>
      ...
      <div><a href="/login"><Button color="success">Login with Spotify</Button></a></div>
    </div>
    <div>
      ...
      <div><a href="https://github.com/ilya-mikhaylov/spotifave-react"><Button color="secondary">Check out GitHub repository</Button></a></div>
    </div>
  </div>
);
